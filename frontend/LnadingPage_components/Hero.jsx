        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="slide-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                className="gradient-cta text-white px-8 py-3 rounded-lg text-lg font-medium hover:opacity-90 transition-opacity duration-300 pulse"
                onClick={handleHomepageRoute}
              >
                Find Flat
              </button>
              <button
                className="bg-white text-gray-800 border border-gray-300 px-8 py-3 rounded-lg text-lg font-medium hover:bg-gray-50 transition-colors duration-300"
                onClick={handleHomepageRoute}
              >
                Find a Flatmate
              </button>
