...
//         "http://localhost:3000/api/user/getFlats/user",
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }
//       );
...
//       const response = await axios.get(
//         "http://localhost:3000/api/user/getFlatmates/user",
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }
//       );
...
//       const endpoint =
//         type === "flat"
//           ? `http://localhost:3000/api/flats/${id}`
//           : `http://localhost:3000/api/flatmates/${id}`;
...
const ProfilePage = () => {
  ...
  const handleDelete = async (id, type) => {
    try {
      ...
      const endpoint =
        type === "flat"
          ? `http://localhost:3000/api/user/getflats/${id}`
          : `http://localhost:3000/api/user/getFlatmates/${id}`;
